        ...
        <div className='flex align-start'>
          ...
          <div className='flex-20'>
            ...
            <nav>
              <ul>
                <li>
                  <a href='https://www.w3.org'>About us</a>
                </li>
                <li>
                  <a href='https://www.w3.org'>Join our team</a>
                </li>
                <li>
                  <a href='https://www.w3.org'>Read blog</a>
                </li>
                <li>
                  <a href='https://www.w3.org'>Press</a>
                </li>
              </ul>
            </nav>
          </div>
          <div className='flex-20'>
            ...
            <nav>
              <ul>
                <li>
                  <a href='https://www.w3.org'>Pricing</a>
                </li>
                <li>
                  <a href='https://www.w3.org'>Documentation</a>
                </li>
                <li>
                  <a href='https://www.w3.org'>Support</a>
                </li>
              </ul>
            </nav>
          </div>
